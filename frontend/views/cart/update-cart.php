...
<? foreach ($cartItems['cart'] as $item) { ?>
    <tr id="<?= $item['id'] ?>" class="cart_item">
        ...
        <td class="product-thumbnail">
            <a href="<?= Url::to(['catalog/product', 'prod' => $item['name_prod_tr'], 'cat' => $item['name_cat_tr']]) ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?= Yii::getAlias("@web/img/catalog/".$item['image'])?>"></a>
        </td>
